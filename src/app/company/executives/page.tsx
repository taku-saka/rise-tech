  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50/95 to-blue-50/95 py-20 relative z-10 page-fade-in">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {/* Executives */}
        <div className="mb-16">
          <h2 className="font-serif text-3xl font-bold mb-8 text-center gradient-text stagger-fade-in stagger-delay-1">
            役員
          </h2>
          <div className="grid grid-cols-2 gap-8">
            {executives
              .filter((exec) => exec.type === "executive")
              .map((executive, index) => (
                <Link
