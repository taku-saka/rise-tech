          ...
          {achievements.map((achievement, index) => {
            return (
              ...
              >
                <div
                  key={achievement.id}
                  className={`flex flex-col justify-between h-full bg-white p-6 rounded-2xl hover-lift-enhanced shadow-lg cursor-pointer group stagger-fade-in stagger-delay-${
                    (index % 6) + 1
                  }`}
                >
                  <div>
                    ...
                    <p className="text-gray-600 text-sm mb-4 min-h-[3.5rem]">
